<template>
  <nav class=" w-full flex flex-col bg-gray-700  px-4 py-4">
    ...
    <div class="  flex flex-col mt-5">
        <router-link class=" flex-col items-center text-xs font-medium sm:text-base lg:flex-row flex  my-2 text-gray-400" to="/"> 
        ...
        <router-link class=" flex-col items-center text-xs font-medium sm:text-base lg:flex-row flex  my-2 text-gray-400" to="/client"> 
