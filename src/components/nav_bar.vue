<template>
  <nav class=" flex flex-col bg-gray-700  px-4 py-4">
    <div class="  w-full flex justify-center border-b border-gray-500 py-3 "> 
    ...
    <div class="  flex flex-col mt-5">
        <router-link class=" flex flex-row my-2 text-gray-400" to="/"> 
        ...
        <router-link class=" flex flex-row my-2 text-gray-400" to="/reservation"> 
        ...
        <router-link class=" flex flex-row my-2 text-gray-400" to="/client"> 
